...
const firstArticle = document.querySelector("section.posts article:first-child").append;
const secondArticle = document.querySelector("section.posts article:nth-child(2)").prepend();  
